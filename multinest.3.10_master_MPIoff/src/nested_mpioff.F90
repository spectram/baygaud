...
module Nested_mpioff
  use utils1_mpioff
  use kmeans_clstr_mpioff
  use xmeans_clstr_mpioff
  use posterior_mpioff
  use priors_mpioff
...
contains
  ...
  subroutine NESTRUN_MPIOFF(nest_IS,nest_mmodal,nest_ceff,nest_nlive,nest_tol,nest_ef,nest_ndims,nest_totPar,nest_nCdims,maxClst, &
